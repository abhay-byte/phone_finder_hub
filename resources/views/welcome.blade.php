...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] min-h-screen flex flex-col font-sans antialiased overflow-x-hidden">

    <!-- Navigation -->
    <nav
        class="fixed w-full z-50 top-0 transition-all duration-300 backdrop-blur-md bg-white/70 dark:bg-black/70 border-b border-gray-100 dark:border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden sm:flex sm:space-x-8">
                    <a href="{{ route('home') }}"
                        class="text-gray-900 dark:text-white px-3 py-2 text-sm font-medium border-b-2 border-teal-500">Home</a>
                    ...
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}"
                                class="text-sm font-semibold text-gray-900 dark:text-white hover:text-teal-500 transition-colors">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}"
                                class="text-sm font-semibold text-gray-900 dark:text-white hover:text-teal-500 transition-colors">Log
                                in</a>
                        @endauth
                    @endif
                </div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 text-center animate-fade-in-up">
                <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div
                        class="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 dark:text-gray-400 ring-1 ring-gray-900/10 dark:ring-white/10 hover:ring-gray-900/20 dark:hover:ring-white/20 transition-all">
                        Announcing UEPS 45 & FPI Methodology. <a href="{{ route('methodology.ueps') }}"
                            class="font-semibold text-teal-600 dark:text-teal-400"><span class="absolute inset-0"
                ...
                <h1 class="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-6xl mb-6">
                    Find Your Perfect Phone using <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-500">Data, Not
                        Hype.</span>
                </h1>
                <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300 max-w-xl mx-auto">
                    Stop guessing. Use our scientific <b>UEPS 45</b> methodology and <b>Final Performance Index
                        (FPI)</b> to find the absolute best device for your budget.
                </p>
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="{{ route('phones.rankings') }}"
                        class="rounded-full bg-teal-600 px-8 py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-teal-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600 transition-all hover:scale-105 shadow-teal-500/30">
                        View Rankings ->
                    </a>
                    <a href="{{ route('methodology.ueps') }}"
                        class="text-sm font-semibold leading-6 text-gray-900 dark:text-white hover:text-teal-500 transition-colors">
                ...
                <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-3">
                    ...
                    <div class="flex flex-col animate-stagger-fade-in delay-200">
                        ...
                        <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
                            <p class="flex-auto">A comprehensive 200-point scoring system evaluating 40+ touchpoints
                                including build quality, display efficiency, sustained performance, and camera
                                versatility.</p>
                            <p class="mt-6">
                                <a href="{{ route('methodology.ueps') }}"
                                    class="text-sm font-semibold leading-6 text-teal-600 hover:text-teal-500">Learn more
                    ...
                    <div class="flex flex-col animate-stagger-fade-in delay-300">
                        ...
                        <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
                            <p class="flex-auto">A weighted metric combining AnTuTu v11 (40%), Geekbench (40%), and
                                3DMark (20%) scores to provide a single, normalized performance rating.</p>
                            <p class="mt-6">
                                <a href="{{ route('methodology.fpi') }}"
                                    class="text-sm font-semibold leading-6 text-blue-600 hover:text-blue-500">See
                                    formula <span aria-hidden="true">→</span></a>
                            </p>
                        </dd>
                    </div>
                    ...
                    <div class="flex flex-col animate-stagger-fade-in delay-500">
                        ...
                        <dd class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-400">
                            <p class="flex-auto">We calculate the raw "Performance per Rupee" and "UEPS per Rupee" to
                                help you identify the true budget kings and flagship killers.</p>
                            <p class="mt-6">
                                <a href="{{ route('phones.rankings', ['tab' => 'value']) }}"
                                    class="text-sm font-semibold leading-6 text-purple-600 hover:text-purple-500">Check
                                    value -> <span aria-hidden="true">→</span></a>
                            </p>
                        </dd>
                    </div>
...
<body
    ...
    <div
        class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0 animate-fade-in-up">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                    ...
                    <li
                        ...
                        <span>
                            ...
                            <a href="https://laravel.com/docs" target="_blank"
                                class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-teal-600 dark:text-teal-500 ml-1">
            ...
            <div
                class="bg-teal-50 dark:bg-[#0a0a0a] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                {{-- Laravel Logo --}}
                <svg class="w-full text-teal-600 dark:text-teal-500 transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6"

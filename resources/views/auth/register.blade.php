        ...
        <div class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 p-8 delay-100 animate-enter">
            <form method="POST" action="{{ route('register') }}" novalidate hx-boost="false">
                ...
                <button type="button" id="google-signin-btn"
                        class="w-full flex justify-center items-center gap-2 rounded-xl bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 font-semibold py-3 px-4 text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 active:scale-[0.98]">

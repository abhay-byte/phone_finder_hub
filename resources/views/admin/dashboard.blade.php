...
<div class="mb-8 flex items-center justify-between">
    <div>
        ...
        <p class="text-slate-400 text-sm mt-1">Welcome back, {{ auth()->user()->name ?? auth()->user()->username }}</p>
    </div>
    <a href="{{ route('admin.phones.add') }}"
       class="inline-flex items-center gap-2 bg-teal-500 hover:bg-teal-400 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-all shadow-lg shadow-teal-500/20 hover:shadow-teal-500/40">

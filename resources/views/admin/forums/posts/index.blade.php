                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                    ...
                    <td class="py-4 px-6 whitespace-nowrap">
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('admin.forum.posts.show', $post) }}" class="inline-flex p-2 text-teal-500 hover:bg-teal-50 dark:hover:bg-teal-500/10 rounded-lg transition-colors" title="View & Moderate">

            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                    ...
                    <td class="py-4 px-6 text-right space-x-2 whitespace-nowrap">
                        <a href="{{ route('admin.forum.categories.edit', $category) }}" class="inline-block p-2 text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-lg transition-colors" title="Edit">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
                        </a>
                        
                        <form action="{{ route('admin.forum.categories.destroy', $category) }}" method="POST" class="inline-block" onsubmit="return confirm('WARNING: Are you sure you want to delete this category? All posts and comments inside it will be PERMANENTLY DELETED. This action cannot be undone.');">
                            @csrf
                            @method('DELETE')

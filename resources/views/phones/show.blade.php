                    ...
                    <div class="space-y-4">
                        ...
                        <h1
                            ...
                            @if(!$phone->benchmarks || !$phone->benchmarks->antutu_score || !$phone->benchmarks->geekbench_single || !$phone->benchmarks->geekbench_multi)
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 text-amber-500 text-sm font-bold border border-amber-500/20 backdrop-blur-sm animate-pulse tracking-normal">

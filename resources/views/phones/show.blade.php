                ...
                <div class="lg:col-span-7 space-y-10 order-last lg:order-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <h1
                            ...
                            {{ $phone->name }}
                            @if(!$phone->benchmarks || !$phone->benchmarks->antutu_score || !$phone->benchmarks->geekbench_single || !$phone->benchmarks->geekbench_multi || !$phone->benchmarks->dmark_wild_life_extreme)
                                <span class="inline-flex items-center px-3 py-1 rounded-full bg-amber-500/10 text-amber-500 text-sm font-bold border border-amber-500/20 backdrop-blur-sm animate-pulse tracking-normal">
                                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg><span class="ml-1.5">Unverified Benchmarks</span>
                                </span>
                            @endif
                        </h1>

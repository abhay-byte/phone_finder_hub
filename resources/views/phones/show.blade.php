...
@section('content')
    <div
        class="bg-gray-50 dark:bg-slate-950 min-h-screen pt-14 pb-12 font-sans text-gray-900 dark:text-gray-100 selection:bg-teal-500 selection:text-white animate-fadeInUp">

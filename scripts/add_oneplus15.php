...
$phone->connectivity()->updateOrCreate([], [
    ...
    // 'audio_quality' removed as requested
...
$phone->benchmarks()->updateOrCreate([], [
    ...
    // 'battery_endurance_hours' removed as requested
]);

echo "OnePlus 15 updated successfully with new revisions.\n";

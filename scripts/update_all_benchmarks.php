...
foreach ($phones as $name) {
    ...
    if ($bench->dxomark_score === null) {
        $bench->dxomark_score = 0;
    }
    if ($bench->phonearena_camera_score === null) {
        $bench->phonearena_camera_score = 0;
    }
    if ($bench->other_benchmark_score === null) {
        $bench->other_benchmark_score = 0;
    }
